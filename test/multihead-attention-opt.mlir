func.func @forward(%input1 : tensor<1x512x128xf32>, %input2 : tensor<1x512x128xf32>, %input3 : tensor<1x512x128xf32>, %input4 : tensor<1x512x512xf32>) -> tensor<1x512x128xf32> { 
  ...
  %8 = "ufront.transpose"(%7) {perm = [0, 2, 1, 3]} : (tensor<1x512x16x8xf32>) -> tensor<1x16x512x8xf32>
  ...
  %11 = "ufront.transpose"(%10) {perm = [0, 2, 1, 3]} : (tensor<1x512x16x8xf32>) -> tensor<1x16x512x8xf32>
  ...
  %14 = "ufront.transpose"(%13) {perm = [0, 2, 1, 3]} : (tensor<1x512x16x8xf32>) -> tensor<1x16x512x8xf32>
  ...
  %17 = "ufront.transpose"(%12) {perm = [0, 2, 1]} : (tensor<16x512x8xf32>) -> tensor<16x8x512xf32>
  ...
  %20 = "ufront.eq"(%16) {comparator = 0.0} : (tensor<16x512x512xf32>) -> tensor<16x512x512xf32>
  ...
  %25 = "ufront.transpose"(%24) {perm = [0, 2, 1, 3]} : (tensor<1x16x512x8xf32>) -> tensor<1x512x16x8xf32>
